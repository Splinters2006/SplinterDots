...
fn bar_widget_qml(
    ...
    match normalize_bar_widget_id(widget) {
...
mod tests {
    ...
    fn status_widgets_launch_their_control_panels() {
        ...
        assert!(volume.contains("width: 86"));
        assert!(volume.contains("Rectangle"));
        assert!(volume.contains("volumeText"));
